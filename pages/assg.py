...
# Display the program ratings
st.subheader("Program Ratings")
ratings_data = {"Program": all_programs, **{f"Slot {i+6:02d}:00": [ratings[program][i] for program in all_programs] for i in range(len(ratings[all_programs[0]]))}}
